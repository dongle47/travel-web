          ...
          <Space direction="vertical">
            ...
            <div className="fs-6" style={{ width: "50rem" }}>
              <Text className="my-0 mx-auto">
                ...
                Provident dolorem voluptate ipsa veniam veritatis, nemo ratione
                cumque cupiditate? Consequatur, labore id sunt cum corporis
                dignissimos facere aspernatur ipsum enim esse?
              </Text>
            </div>
            <Button
