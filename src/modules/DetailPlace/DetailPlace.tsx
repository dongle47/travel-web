                ...
                >
                  <Space direction="vertical" size={25}>
                    ...
                    <Text className="fs-6">
                      ...
                      viverra nam. Libero id faucibus nisl tincidunt eget nullam
                      non nisi est. Arcu odio ut sem nulla. Amet tellus cras
                      adipiscing enim. Et magnis dis parturient montes.
              ...
              <Col span={6}>
                <Space style={{}} className="" direction="vertical" size={15}>
                  ...
                  <Text style={{ fontSize: "0.9rem" }}>
                    Lorem ipsum dolor sit amet adipisicing elit. Inventore id
                    iure maxime repellendus a rem quisquam eum nisi et aliquam
                    deserunt quam architecto ducimus magnam, doloribus sint,
